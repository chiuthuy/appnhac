...
public class DanhsachcacplalistAdapter extends RecyclerView.Adapter<DanhsachcacplalistAdapter.ViewHolder>{
    Context context;
    ArrayList<Playlist> mangplaylist;

    public DanhsachcacplalistAdapter(Context context, ArrayList<Playlist> mangplaylist) {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder{
        ...
        public ViewHolder(@NonNull View itemView) {
            ...
            txttenplaylist=itemView.findViewById(R.id.txttendanhsachcacplaylist);
