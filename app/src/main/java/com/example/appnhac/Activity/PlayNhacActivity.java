...
import com.example.appnhac.Fragmet.Fragment_Dia_Nhac;
import com.example.appnhac.Fragmet.Fragment_Play_Danh_Sach_Cac_Bai_Hat;
...
public class PlayNhacActivity extends AppCompatActivity {
    ...
    private void init() {
        ...
        txttimsong=findViewById(R.id.txttimmesong);
        txttotaltimsong=findViewById(R.id.txttotaltimesong);
